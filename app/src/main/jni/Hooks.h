...
void hack_thread() {
    ...
    get_Transform = (void *(*)(void *)) getAbsoluteAddress(targetLibName,0x23F80D8);
    
    //UnityEngine class Transform public Vector3 get_position() { };
    get_position = (Vector3 (*)(void*)) getAbsoluteAddress(targetLibName, 0x240ABDC);
    
    //UnityEngine public sealed class Camera public static Camera get_main() { };
    get_camera = (void *(*)()) getAbsoluteAddress(targetLibName, 0x23C0438);
    
    //UnityEngine public sealed class Camera public Vector3 WorldToScreenPoint(Vector3 position) { };
    get_screenpos = (Vector3 (*)(void *, Vector3)) getAbsoluteAddress(targetLibName, 0x23C00C4);
    
    // public class EnemyAIGranny : MonoBehaviour public virtual void FixedUpdate() { };
    MSHookFunction((void *) getAbsoluteAddress(targetLibName, 0xA3B58C), 
    (void *) &Player_update,
    (void **) &old_Player_update);                                  
}
